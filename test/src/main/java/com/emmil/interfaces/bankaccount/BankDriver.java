...
public class BankDriver{
	...
	public static void main(String[] args) {
		...
		BankAccount studentAccount = new CheckingAccount("Jane Doe", 100789.50, 500, 0, 35, "78FT7JH5", 366712642);
		BankAccount healthAccount = new SavingsAccount("John Doe", 250789.72, 1000, 0, 25, 10, 1829164700);
		...
		System.out.println(studentAccount.hashCode());
		System.out.println();
		...
		System.out.println(healthAccount.hashCode());
	}
